...
#define SENSORLESS_BACKOFF_MM  { 10, 10, 2 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 5, 5, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 20, 20, 3 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 120*60, 120*60, 60*60} // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
